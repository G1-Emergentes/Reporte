...
| **US23** | Añadido automático al armario mediante QR de adquisición | Como comprador, quiero escanear el QR de la etiqueta de una prenda comprada para agregarla instantáneamente a mi armario virtual sin tener que tomarle fotos. | **ESCENARIO 01:** Registro automático por compra exitosa<br>**DADO** que el comprador escanea el QR de la etiqueta de su prenda recién adquirida,<br>**CUANDO** el sistema valida el código de adquisición,<br>**ENTONCES** incorpora la prenda automáticamente a su armario virtual con su foto y atributos oficiales.<br><br>**ESCENARIO 02:** Intento de reuso de QR de adquisición<br>**DADO** que se intenta escanear un QR de adquisición que ya fue reclamado,<br>**CUANDO** el sistema verifica la validez,<br>**ENTONCES** rechaza la acción e informa que la prenda ya fue añadida a un armario. | EP04 |
...
| **US26** | Ajuste y refinamiento manual de medidas corporales | Como usuario, quiero ajustar manualmente los valores numéricos o deslizadores de mi silueta corporal por si deseo hacer correcciones a la estimación automática. | **ESCENARIO 01:** Edición manual de proporciones<br>**DADO** que el avatar ya tiene unas dimensiones estimadas,<br>**CUANDO** el usuario modifica los campos de estatura o contornos en el panel de ajuste,<br>**ENTONCES** la estructura 3D del avatar actualiza sus proporciones en tiempo real.<br><br>**ESCENARIO 02:** Validación de rango de medidas<br>**DADO** que el usuario ingresa un valor numérico fuera de los parámetros lógicos,<br>**CUANDO** intenta guardar,<br>**ENTONCES** el sistema señala el error y muestra el rango válido permitido. | EP05 |
...
| **US29** | Simulación de ajuste y mapa de calce | Como usuario, quiero consultar el mapa de ajuste de prendas comerciales sobre mi avatar para saber si la talla me quedará apretada, justa u holgada. | **ESCENARIO 01:** Mapa de ajuste por talla<br>**DADO** que el usuario prueba una prenda comercial de cierta talla en su avatar,<br>**CUANDO** activa la vista "Mapa de Ajuste",<br>**ENTONCES** el sistema muestra marcadores de color señalando el nivel de holgura o compresión en cada zona del cuerpo.<br><br>**ESCENARIO 02:** Sugerencia de cambio de talla<br>**DADO** que la talla seleccionada es demasiado pequeña para las proporciones del avatar,<br>**CUANDO** se ejecuta la simulación,<br>**ENTONCES** la app emite un aviso sugiriendo probar una talla superior. | EP05 |
